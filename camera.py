...
class VideoCamera(object):
    ...
    def get_frame(self, makesave, imageformat):
        ...
        model = tf.keras.models.load_model("mid_model.keras" , custom_objects=None, compile=True)
    ...
    def applyfilter(self):
        ...
        model = tf.keras.models.load_model("my_model.h5" ,custom_objects=None, compile=True, options=None)
...
output_frame = video_camera.get_frame(makesave="noSave", imageformat="jpg")
output_save = video_camera.save(imageformat="jpg")
output_savecnn = video_camera.savecnn(imageformat="jpg")   
    
# Print the result (output_result may contain the combined image with the filter and other information)
